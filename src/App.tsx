...
const pageStyle: React.CSSProperties = {
  ...
  minHeight: "100vh",
  background:
    "radial-gradient(circle at 10% 10%, rgba(59,130,246,0.2), transparent 35%), radial-gradient(circle at 90% 25%, rgba(168,85,247,0.16), transparent 34%), #020617",
  color: "#e2e8f0",
...
const cardStyle: React.CSSProperties = {
  ...
  borderRadius: "16px",
  padding: "24px",
  boxShadow: "0 18px 45px rgba(8, 15, 34, 0.45)",
...
export function App() {
  return (
    <main style={pageStyle}>
      <div className="flash-orb flash-orb-left" />
      <div className="flash-orb flash-orb-right" />
      ...
      <section style={{ ...containerStyle, paddingTop: "72px", paddingBottom: "42px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", marginTop: "24px" }}>
          <span style={pulseStatStyle}>24/7 feed monitoring</span>
          <span style={pulseStatStyle}>87 avg conviction score</span>
          <span style={pulseStatStyle}>sub-60 minute alerts</span>
        </div>
      </section>
      ...
      >
        <article className="lift-card" style={cardStyle}>
          <h2 style={{ margin: "0 0 12px", color: "#fff", fontSize: "1.5rem" }}>
            What our agents monitor
          </h2>
      ...
      <section style={{ ...containerStyle, paddingTop: "10px", paddingBottom: "20px" }}>
        ...
        >
          <h2 style={{ marginTop: 0, marginBottom: "18px", color: "#fff", fontSize: "1.5rem" }}>
          ...
          >
            <p style={{ margin: 0 }}>
              <strong style={{ color: "#fff" }}>Asset:</strong> 42-unit multifamily, Sun Belt
              secondary market.
            </p>
            <p style={{ margin: 0 }}>
              <strong style={{ color: "#fff" }}>Status:</strong> Pre-foreclosure, notice filed
              within the last 14 days.
            </p>
            <p style={{ margin: 0 }}>
              <strong style={{ color: "#fff" }}>Projected entry discount:</strong> 18% below
              trailing market comps.
            </p>
            <p style={{ margin: 0 }}>
              <strong style={{ color: "#fff" }}>AI conviction:</strong> 87/100 with moderate
              renovation risk.
            </p>
          </div>
        </article>
      ...
      <section style={{ ...containerStyle, paddingTop: "18px", paddingBottom: "72px" }}>
        <div
          ...
          style={{
            ...
            padding: "28px",
            background:
              "linear-gradient(90deg, rgba(34,211,238,0.12), rgba(59,130,246,0.11), rgba(99,102,241,0.11))",
          }}
        >
          <h2 style={{ margin: 0, color: "#fff", fontSize: "clamp(1.5rem, 3vw, 2rem)" }}>
          ...
          >
            Falcon agents collect, rank, and explain multifamily distress opportunities
            so your team can spend time making offers—not hunting fragmented data.
          </p>
          <a
